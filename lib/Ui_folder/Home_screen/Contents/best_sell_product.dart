...
class BestSellProduct extends StatefulWidget {
  const BestSellProduct({super.key});

  @override
  State<BestSellProduct> createState() => _BestSellProductState();
}

class _BestSellProductState extends State<BestSellProduct> {
    ...
    return Column(
      ...
      children: [
        ...
        const Padding(padding: EdgeInsets.symmetric(horizontal: 15,vertical: 5),
          child:RowWidget(text1: "Best Selling Products", text2: "View All"),
        ),
        ...
        SizedBox(height:260,//color: Colors.grey,
          child:StreamBuilder<QuerySnapshot>(
            stream:FirebaseFirestore.instance.collection('subCategories').where('productRatting', isGreaterThan:3.9 ).orderBy('productRatting',descending: true).snapshots(),
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> DetailsScreen(productId: data['productId'],
                            ...
                            oldPrice: data['oldPrice'],newPrice:data['newPrice'],productType:data['productType'], productDescription: data['productDescription'],
                          )));
                        },
                        child: Column(
                          children: [
